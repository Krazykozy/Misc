...
function get_sets()
		...
		sets.Idle.Standard = {ammo="Adlivun Bullet",
				      head="Blood Mask", neck="Wiglen gorget", ear1="Colossus's earring", ear2="Darkness earring",
				      body="Kheper jacket", hands="Denali wristbands", ring1="Defending ring", ring2="Sheltered ring",
				      back="Engulfer cape", waist="Flume belt", legs="Iuitl tights", feet="Skd. jambeaux +1"}

                sets.Idle.DT = {ammo="Adlivun Bullet",
			        head="Blood Mask", neck="Wiglen gorget", ear1="Colossus's earring", ear2="Darkness earring",
			        body="Kheper jacket", hands="Denali wristbands", ring1="Defending ring", ring2="Sheltered ring",
			        back="Engulfer cape", waist="Flume belt", legs="Iuitl tights", feet="Skd. jambeaux +1"}

                sets.Idle.Town = {ammo="Adlivun Bullet",
				  head="Blood Mask", neck="Wiglen gorget", ear1="Colossus's earring", ear2="Darkness earring",
				  body="Kheper jacket", hands="Denali wristbands", ring1="Defending ring", ring2="Sheltered ring",
				  back="Engulfer cape", waist="Flume belt", legs="Iuitl tights", feet="Skd. jambeaux +1"}
		...
		sets.MeleeTP.Standard = {ammo="Adlivun bullet",
					 head="Thur. chapeau +1", neck="Asperity necklace", ear1="Brutal earring", ear2="Suppanomimi",
					 body="Thaumas coat", hands="Lak. gants", ring1="Epona's ring", ring2="Rajas ring",
					 back="Atheling mantle", waist="Cetl belt", legs="Iuitl tights", feet="Manibozho boots"}
		...
		sets.Requiescat.Attack = {ammo="Adlivun bullet",
					  head="Whirlpool mask", neck="Soil gorget", ear1="Brutal earring", ear2="Moonshade earring",
					  body="Qaaxo harness", hands="Iuitl wristbands", ring1="Epona's ring", ring2="Aquasoul ring",
					  back="Atheling mantle", waist="Soil belt", legs="Quiahuiz trousers", feet="Iuitl gaiters"}
		...
		sets.RangedTP.Standard = {ammo="Adlivun bullet",
					  head="Lanun tricorne +1", neck="Ocachi gorget", ear1="Flame pearl", ear2="Clearview earring",
					  body="Lak. frac +1", hands="Sigyn's bazubands", ring1="Moepapa ring", ring2="Rajas ring",
					  back="Gunslinger's cape", waist="Elanid belt", legs="Nahtirah trousers", feet="Lak. bottes"}
		...
		sets.LastStand.Attack = {ammo="Adlivun bullet",
					 head="Lanun tricorne +1", neck="Light gorget", ear1="Moonshade earring", ear2="Clearview earring",				 body="Lak. frac +1", hands="Sigyn's bazubands", ring1="Moepapa ring", ring2="Stormsoul ring",
					 back="Terebellum mantle", waist="Light belt", legs="Nahtirah trousers", feet="Lak. bottes"}
		...
		sets.LeadenSalute.MagicAttack = {ammo="Orichalc. bullet",
	  				         head="Lanun tricorne +1", neck="Stoicheion medal", ear1="Novio earring", ear2="Friomisi earring",		         body="Lanun frac", hands="Thur. gloves +1", ring1="Acumen ring", ring2="Archon ring",
		...
		sets.Wildfire.MagicAttack = {ammo="Orichalc. bullet",
		...
		sets.JA.RandomDeal = {ammo="Adlivun bullet",
		...
		sets.JA.WildCard = {ammo="Adlivun bullet",
				    head="Lanun tricorne +1", neck="Twilight torque", ear1="Colossus's earring", ear2="Darkness earring",     			    body="Lanun frac", hands="Denali wristbands", ring1="Defending ring", ring2="Dark ring",
				    back="Mollusca mantle", waist="Flume belt", legs="Iuitl tights", feet="Lanun bottes"}
		...
		sets.QuickDraw.MagicAttack = {ammo="Adlivun bullet",
