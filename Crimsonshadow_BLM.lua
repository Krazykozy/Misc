...
function init_gear_sets()
    ...
    --------------------------------------
	sets.magicAcc = {
		head="Jhakri coronal +1",neck="Incanter's Torque",ear1="Barkarole Earring",ear2="Friomisi Earring",
		body="Spaekona's coat +3",hands="Jhakri cuffs +1",ring1="Stikini Ring",ring2="Aldoulin Ring",
		back="Taranus's Cape",waist="Hachirin-no-Obi",legs="Ea Slops",feet="Jhakri pigaches +1"}

	sets.FC = {head="Welkin Crown",ear1="Etiolation Earring",ear2="Loquacious Earring", neck="Orunmila's Torque",
        body="Shango Robe",hands="Repartie Gloves",ring1="Prolix Ring",ring2="Veneficium Ring",
	...
	sets.precast.WS['Myrkr'] = {
		...
		body="Rosette Jaseran +1",hands="Revealer's Mitts",ring1="Sangoma Ring",ring2="Stikini Ring",
    ...
    sets.midcast['Elemental Magic'] = {main="Grioavolr",sub="Alber Strap",ammo="Witchstone",
		head="Jhakri coronal +1",neck="Sanctity Necklace",ear1="Friomisi Earring",ear2="Barkarole Earring",
        body="Spaekona's coat +3",hands="Jhakri cuffs +1",ring1="Stikini Ring",ring2="Adoulin Ring",
        back="Taranus's Cape",waist="Hachirin-no-Obi",legs="Jhakri slops +1",feet="Jhakri pigaches +1"}
    ...
    sets.idle = {main="Grioavolr",sub="Niobid Strap",ammo="Pemphredo Tathlum",
        head="Jhakri coronal +1",neck="Bathy Choker",ear1="Etiolation Earring",ear2="Infused Earring",
        body="Jhakri Robe +1",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Defending Ring",
        back="Taranus's Cape",waist="Fucho-no-obi",legs="Assiduity Pants +1",feet="Crier's Gaiters"}
