...
function get_sets()
	...
	WeaponIndex = 1
	WeaponArray = {"Tsurumaru","Polearm"} -- Default TP Set Is Kogarasumaru. Can Delete Any Weapons/Sets That You Don't Need Or Replace/Add The New Weapons That You Want To Use. --
	IdleIndex = 1
	...
	-- JA Sets --
	sets.JA = {}
	sets.JA.Provoke = {back="Fravashi Mantle"}
		...
		if spell.type == "WeaponSkill" then
			if player.status ~= 'Engaged' then -- Cancel WS If You Are Not Engaged. Can Delete It If You Don't Need It --
				...
				if (spell.english == "Apex Arrow") and (player.tp > 2999 or buffactive.Sekkanoki or (player.tp > 1999 and buffactive.Hagakure)) then -- Equip Flame Pearl When You Have 300 TP or Sekkanoki On or 200+ TP For Hagakure --
					equipSet = set_combine(equipSet,{ear1="Breeze Pearl"})
				end
