...
function get_sets()
    ...
    sets.Idle.Regen = {
            ...
            legs="Mummu Kecks +1",
            feet="Jute Boots +1"}
    sets.Idle.Regen.Odium = set_combine(sets.Idle.Regen,{
            main={ name="Taming Sari", augments={'STR+10','DEX+10','DMG:+15','"Treasure Hunter"+1',}},
            sub="Odium"})
    sets.Idle.Regen.Sari = set_combine(sets.Idle.Regen,{
            main={ name="Taming Sari", augments={'STR+10','DEX+10','DMG:+15','"Treasure Hunter"+1',}},
    ...
    sets.Idle.Movement = set_combine(sets.Idle.Regen,{
            ...
            legs="Mummu Kecks +1",
            feet="Jute Boots +1"})
    sets.Idle.Movement.Odium = set_combine(sets.Idle.Movement,{
            main={ name="Taming Sari", augments={'STR+10','DEX+10','DMG:+15','"Treasure Hunter"+1',}},
            sub="Odium"})
    sets.Idle.Movement.Sari = set_combine(sets.Idle.Movement,{
            main={ name="Taming Sari", augments={'STR+10','DEX+10','DMG:+15','"Treasure Hunter"+1',}},
            sub={ name="Taming Sari", augments={'STR+9','DEX+8','DMG:+14',}},})
...
function status_change(new,old)
    ...
    elseif new == 'Engaged' then
        ...
        if (buffactive.Embrava and (buffactive.Haste or buffactive.March) and buffactive['Geo-Haste'] and buffactive['Mighty Guard']) or (buffactive.March == 2 and buffactive.Haste and buffactive['Geo-Haste']) and equipSet["HighHaste"] then
        ...
        if (buffactive.Haste and buffactive.March == 2) and (buffactive.Embrava and (buffactive.March == 2 or (buffactive.March and buffactive.Haste and buffactive['Mighty Guard']))) and equipSet["HighHaste"] then
            equipSet = equipSet["HighHaste"]
        end
        if buffactive.Embrava and (buffactive.Haste or buffactive.March and buffactive['Mighty Guard']) and equipSet["HighHaste"] then
            equipSet = equipSet["HighHaste"]
        end
        if (buffactive.March == 1 and buffactive.Haste and buffactive["Geo-Haste"] and buffactive['Mighty Guard']) or (buffactive.March == 2) and equipSet["MidHaste"] then
            equipSet = equipSet["MidHaste"]
        end
        if SA then
